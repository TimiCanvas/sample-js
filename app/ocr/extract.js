...
const OCR_PROMPT = `You are extracting data from a fixed-format shipping manifest PDF or Image.
...
- Accuracy and completeness are more important than brevity`; // unchanged
